        ...
        >
          ...
          <div className="w-[85vw] sm:w-[85vw] md:w-[60vw] lg:w-[45vw] xl:w-[40vw] flex-shrink-0 flex flex-col justify-center items-start px-2 sm:px-4 pl-0 py-8">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full shadow-sm backdrop-blur-sm mb-6 bg-primary-50 border border-primary-100"
            >
              <Lightbulb className="w-3.5 h-3.5 text-primary-600" strokeWidth={2.5} />
