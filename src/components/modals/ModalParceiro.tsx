...
import { useModalParceiro } from '../../hooks/useModalParceiro';
...
// ═══════════════════════════════════════════════════════════════
export default function ModalParceiro() {
    const { isOpen, selectedPlan, closeModal } = useModalParceiro();
                    ...
                    >
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {(state === 'form' || state === 'error') && (
                                <m.div key="f" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }} className="px-7 pt-6 pb-7 sm:px-10 sm:pt-7 sm:pb-8 overflow-y-auto sm:overflow-visible">
                                    {/* MenuPrincipal */}
                                    ...
                                    <AnimatePresence>
                                        {serverErr && (
                                            <m.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} className="flex items-center gap-2 rounded-lg border border-red-500/30 bg-red-500/10 px-3 py-2 text-red-400 mt-3">
                            ...
                            {/* ═══ ENVIANDO ═══ */}
                            {state === 'submitting' && (
                                <m.div key="s" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center gap-4 p-16 min-h-[340px]">
                            ...
                            {/* ═══ SUCESSO ═══ */}
                            {state === 'success' && (
                                <m.div key="ok" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="flex flex-col items-center text-center p-10 sm:p-12">
                                    <m.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', delay: 0.1, stiffness: 300, damping: 20 }} className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border border-green-500/30 bg-green-500/10 shadow-[0_0_30px_rgba(34,197,94,0.25)]">
