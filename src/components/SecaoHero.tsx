          ...
          <div className="flex flex-col lg:flex-row items-center justify-between w-full gap-8">
            ...
            <div className="order-1 lg:order-2 w-full lg:max-w-[700px] flex flex-col items-center text-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-50 border border-primary-100 mb-6 shadow-sm backdrop-blur-sm"
              >
                {/* Trophy SVG */}
                ...
                <span className="text-[10.5px] md:text-[11.5px] font-bold text-primary-800 uppercase tracking-[0.08em]">
                  <TypewriterText text="A MAIOR CONTABILIDADE EXCLUSIVA PARA FARMÁCIAS" delay={1.2} />
                </span>
              </motion.div>
